<aside id="sidebar"
  ...
  <div class="h-full px-3 overflow-y-auto shadow-md bg-gray-50 dark:bg-gray-800">
    <ul class="space-y-2 font-medium mt-16">
      ...
      <li>
        <a href="teams"
           class="flex items-center p-2 text--900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
          <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
      ...
      <li>
        <a href="DevSync"
          ...
          <span class="flex-1 ms-3 whitespace-nowrap">DevSync's</span>
        </a>
      </li>
      <li>
        <a href="#"
